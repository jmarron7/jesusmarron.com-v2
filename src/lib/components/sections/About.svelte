<section id="about" class="mb-8 scroll-mt-16 lg:scroll-mt-24" aria-label="About me">
  ...
  <p class="text-surface-200 mb-4">
    I enjoy using Go and Sveltekit for fullstack applications in my own time. Lately, I've been tinkering with Odin, Rust, and Zig for lower level systems programming and game development. Other areas I've been exploring are machine learning, graphics programming, and distributed systems.
  </p>
</section>